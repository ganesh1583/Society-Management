...
<hr>
    <?php
        ...
        if(pg_num_rows($rs) != 1)
        {
            echo "<script> alert('Society ID Not Found') </script>";
        }
        else
        {
            ...
            echo "<b>Current Balance :  $current_balance</b> <br>";
            echo "Total Income : $total_income <br>";
            echo "Total Expense : $total_expense <br>";
            echo "Last Updated : $last_updated";
        }
        echo "<br><br>";
        echo "<a href='/Society_Management/dashboard/add_funds.php'>Add Funds</a>";
