...
<div class="main">
  ...
  <div class="table-container">
    <div class="table-header">Authentications Requests</div>
    <div class="table-content">
      <?php
        $qry = "select * from authentication_requests where admin_id = $member_id";
        $rs = pg_query($con,$qry);
        ...
        {
            echo "<table>";
            echo "<tr> <th>Req ID</th> <th>First Name</th> <th>Mid Name</th> <th>Last Name</th> <th>Username</th> <th>Phone</th> <th>Age</th> <th>Gender</th> <th>Email</th> <th>Unit No</th> <th>Occupation</th> <th>Family Count</th> <th>Request Date</th> </tr>";
            while($row = pg_fetch_assoc($rs))
            {
                $auth_req_id = $row['auth_req_id'];
                ...
                echo "<tr>";
                echo "<td>$auth_req_id</td> <td>$fname</td> <td>$mname</td> <td>$lname</td> <td>$username</td> <td>$phone</td> <td>$age</td> <td>$gender</td> <td>$email</td>  <td>$unit_no</td> <td>$occupation</td> <td>$family_count</td> <td>$req_date</td>";
                echo "</tr>";
    
                echo "<tr>";

                echo "<td> 
                <form method='post' action='/Society_Management/dashboard/accept_request.php'>
                  <input type='hidden' name='auth_req_id' value='$auth_req_id'>
                    <button type='submit' name='accept'>Accept</button> 
                </form> </td>";

                echo "<td> 
                <form method='post' action='/Society_Management/dashboard/reject_request.php'>
                  <input type='hidden' name='auth_req_id' value='$auth_req_id'>
