...
<div class="table-container">
    <div class="table-header">Complaints</div>
    <div class="table-content">
        <?php
            ...
            $qry = "SELECT * FROM complaint WHERE society_id = $society_id";

            $rs = pg_query($con,$qry);
            
            if(pg_num_rows($rs) == 0)
            {
                echo "No Complaints!!!<br>";
            }
            else
            {
                echo "<table border=1>";
                echo "<tr> <th>Complaint ID</th> <th>Title</th> <th>Description</th> <th>Status</th> <th>Created At</th> <th>Raised By</th> </tr>";
            ...
            echo "<a href='/Society_Management/dashboard/add_complaint.php'>Raise a Complaint</a>";
            echo "<br><br>";
            if($member_type == "admin")
            {
              echo "<a href='/Society_Management/dashboard/change_complaint_status.php'>Change Status of a Complaint</a>"; 
            }
        ?>
    </div>
  </div>
