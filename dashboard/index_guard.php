...
<div class="table-container">
    <div class="table-header">Add Visitor Information</div>
    <div class="table-content">
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
            Enter Visitor Name : <input type="text" name="visitor_name" required>
            <br> <br>
            Enter Purpose : <input type="text" name="purpose" required>
            <br> <br>
            Enter Resident ID : <input type="number" name="resident_id" required>
            <br><br>
        ...
        <?php
            if($_SERVER['REQUEST_METHOD'] == "POST")
            {
              ...
              $qry = "insert into visitor_log (resident_id,visitor_name,visit_date,purpose,society_id) values ($resident_id,'$visitor_name',CURRENT_TIMESTAMP,'$purpose',$society_id)";
              $rs = pg_query($con,$qry);                

              if(!$rs) 
              {
                  echo "<script> alert('Error while inserting into visitor_log table '); </script>";
              }
              else
              {                        
                echo '<script>alert("Success... Visitor Info Uploaded!");</script>';
              }
            }
        ?>
    </div>
