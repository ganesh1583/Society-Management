...
<div class="table-container">
    <div class="table-header">Amenities</div>
    <div class="table-content">
        <?php
            ...
            $qry = "select * from amenities where society_id=$society_id";
            $rs = pg_query($con,$qry);

            if(pg_num_rows($rs) == 0)
            {     
              echo "No Amenities!!!<br><br>";
            }
            else
            {
              echo "<table border=1>";
              echo "<tr> <th>Amenity ID</th> <th>Name</th> <th>Description</th> <th>Category</th> <th>Status</th> </tr>";
              while($row = pg_fetch_assoc($rs))
              {
                ...
                echo "<tr>";
                echo "<td>$amenity_id</td> <td>$name</td> <td>$description</td> <td>$category</td> <td>$status</td>";
                echo "</tr>";
            ...
            if($member_type == "admin")
              echo "<br><a href='/Society_Management/dashboard/add_amenity.php'>Add Amenities</a>";
        ?>
    </div>
  </div>
