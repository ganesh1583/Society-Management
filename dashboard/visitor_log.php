...
<div class="table-container">
    <div class="table-header">Visitor Logs</div>
    <div class="table-content">
        <?php
            ...
            $qry = "select * from visitor_log where society_id=$society_id";
            $rs = pg_query($con,$qry);
            ...
            {
                echo "<table border=1>";
                echo "<tr> <th>Visitor Name</th> <th>Purpose</th> <th>Member Name</th> </tr>";
                while($row = pg_fetch_assoc($rs))
                {
                    ...
                    $qry2 = "select first_name, last_name from member where member_id=$resident_id";
                    $rs2 = pg_query($con,$qry2);
                    $row2 = pg_fetch_row($rs2);
                    $first_name = $row2[0]; 
                    $last_name = $row2[1]; 
                    
                    echo "<tr> <td>$visitor_name</td> <td>$purpose</td> <td>$first_name $last_name</td> </tr>";
                }
                echo "</table>";
            }
        ?>
