...
<hr>
    <?php
      ...
      $qry = "select * from society where society_id = $society_id";
      $rs = pg_query($con,$qry);
      
      if(pg_num_rows($rs) != 1)
      {
        echo "<script> alert('Society Information Error') </script>";
      }
      else
      {
        ...
        echo "Society ID : $society_id<br>";
        echo "Society Name : $society_name <br>";
        echo "Society Address : $address <br>";
        echo "Society Admin ID : $admin_id <br>";
