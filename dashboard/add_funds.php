...
<div class="table-container">
    <div class="table-header">Add Funds</div>
    <div class="table-content">
        ...
        <?php
            if($_SERVER['REQUEST_METHOD'] == "POST")
            {
              ...
              {
                  echo "<script> alert('Error while updating funds '); </script>";
                  header("refresh:0;url=/Society_Management/dashboard/add_funds.php");    
              }
              
          
              echo '<script>alert("Success... Funds Updated!");</script>';
              echo '<script>window.location.href = "/Society_Management/dashboard/funds.php";</script>';
            }
        ?>
    </div>
  </div>
