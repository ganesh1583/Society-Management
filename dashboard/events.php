...
<div class="table-container">
    ...
    <div class="table-content">
        <?php
            ...
            $qry = "select * from events where society_id = $society_id and end_date > '$currentDateTime'";
            ...
            {
                echo "<table border=1>";
                echo "<tr> <th>Event ID</th> <th>Event Name</th> <th>Description</th> <th>Start Date</th> <th>End Date</th> </tr>";
                ...
                while($row = pg_fetch_assoc($rs))
                {
                    ...
                    echo "<tr> <td>$event_id</td> <td>$event_name</td> <td>$description</td> <td>$start_date</td> <td>$end_date</td> </tr>";
                }
                echo "</table>";
                echo "<br>";
            }
            ...
            if($member_type == "admin")
            {   
                echo "<a href='/Society_Management/dashboard/add_events.php'>Add Events</a>";
            }
