  ...
  <head>
    ...
    <script>
        function validate()
        {
          ...
          var society_id = document.signupform.society_id.value;
          ...
          if(society_id < 0)
          {
            alert("Society ID Cannot Be Negative");
            return false;
          }
...
<body>  
    <div id="navbar">
     ...
     <div class="center">
      ...
      <form method="POST" action="/Society_Management/authentication/member_signup3.php">
       ...
       <input type="submit" value="Submit Request">
        ...
        <div class="back_button">
          <a href="/Society_Management/authentication/member_signup1.php">Back</a>
        </div>
    ...
    <footer>
      <div id="footer-content">
        <p>&copy; <?php echo date("Y"); ?> Society Management System. All rights reserved.</p>
      </div>
    </footer>
